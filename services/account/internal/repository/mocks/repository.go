...
func (_m *Repository) CreateAccount(ctx context.Context, account *model.Account) (*model.Account, error) {
...
func (_m *Repository) GetAccountByID(ctx context.Context, id string) (*model.Account, error) {
...
func (_m *Repository) ListAccounts(ctx context.Context, skip uint64, take uint64) ([]*model.Account, error) {
...
func (_m *Repository) UpdateAccount(ctx context.Context, account *model.Account) (*model.Account, error) {
	ret := _m.Called(ctx, account)
